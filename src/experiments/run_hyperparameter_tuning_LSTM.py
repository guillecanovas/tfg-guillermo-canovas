...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 2:
        print("Usage: python3 run_hyperparameter_tuning_LSTM.py <electricity/gas/solar_consumption/solar_generation")
        exit(85)
    ...
    for meter_id in list_of_meterIDs:
        command = f"python3 src/experiments/hyperparameter_tuning_LSTM.py {meter_id} {type_of_dataset}"
