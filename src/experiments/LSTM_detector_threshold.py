...
def get_training_testing(type):
  ...
  """
  dir_path = './script_results/false_injection_training_testing_data_aux/' + str(TYPE_OF_DATASET) + '/'
...
def metrics_to_csv(n_tp, n_tn, n_fp, n_fn, accuracy):
    ...
    resulting_csv_path = "./script_results/lstm_threshold/lstm_threshold_experiments_" + str(TYPE_OF_DATASET) + ".csv" 
...
if __name__ == '__main__':
    ...
    sys.argv[2]: meter_id
    sys.argv[3]: threshold value
    sys.argv[4]: type of attack that will be injected
    """

    if len(sys.argv) != 5:
        print("Usage: python3 LSTM_v1 <type_of_dataset> <meter_id> <threshold value> <Avg/FDI10/Swap/RSA_0.25_1.1/RSA_0.5_3/FDI30/None>")
        exit(85)

    TYPE_OF_DATASET = sys.argv[1]
    METER_ID = sys.argv[2]
    THRESHOLD = float(sys.argv[3])
    ATTACK_INJECTION = sys.argv[4]
