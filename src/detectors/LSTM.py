...
if __name__ == '__main__':
    ...
    sys.argv[2]: meter_id
    sys.argv[3]: attack (False, Avg, FDI10, FDI30, RSA_0.25_1.1, RSA_0.5_3, Swap)
    """
    if len(sys.argv) != 4:
        print("Usage: python3 LSTM <type_of_dataset> <meter_id> <attack>")
        exit(85)
    ...
    metrics_to_csv(meterID, "LSTM", attack, time_model_creation, time_model_prediction, n_tp, n_tn, n_fp, n_fn, type_of_dataset)
